    ...
    public static class ClientExtensions
    {
        public static IServiceCollection AddOAuth2Client(this IServiceCollection services, Action<OAuth2ClientOptions> configOptions)
        {
            ...
            services.AddAuthentication(authOptions =>
            {
                ...
                {
                    cookieOptions.Events.OnValidatePrincipal = x => ValidatePrincepal(x, options);
                })
        ...
        private static async Task ValidatePrincepal(CookieValidatePrincipalContext context, OAuth2ClientOptions options)
        {
